...
My focus is on building complex LLM-agentic systems: **Analytica** (webapp coming soon), [**Genesys** (NeurIPS'25 Spotlight)](https://genesys.allen.ai), [**Apeiron** (at MSR)](https://amorphware.com), and [**SocioDojo** (ICLR'24 Spotlight)](https://gam-gray.vercel.app/).
The goal is to achieve autonomous systems that can *robustly*, *trustworthily*, and *scalably* take over critical real-society domains in long-term large-scale deployments, with a holographical perception of the world dynamics. I study ***Hybrid and Neural-symbolic Methods*** that enhance NNs and LLMs with symbolic approaches, such as statistics, logic, programming, and optimization. 
